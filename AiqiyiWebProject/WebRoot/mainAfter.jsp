					...
					<div class="login_middle_3">
						<form>
							<div class="login_middle_3_top">
								...
								<div class="login_middle_3_top_right">
									<form method="post" action="">
										<input class="login_middle_3_input" type="text" oninput="username()" />
							...
							<div id="login_middle_3_middle">
								<input type="password" class="login_middle_3_input" id="login_middle_3_password" oninput="onpassword();submitColorChange(this)" />
